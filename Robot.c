...
void display(void)
{
 ...
 glLoadName(TEXTID);
 glColor3f(1,1,0);
 //DrawTextXY(-2.5,0.2,2.0,0.0015,"4SU12CS089");
 //DrawTextXY(-2.5,0.5,2.0,0.0015,"VIJETHA S.P");
 //DrawTextXY(2.5,2.2,-2.0,0.0025,"4SU12CS103");
 //DrawTextXY(2.5,2.7,-2.0,0.0030,"POOJA.S.PAI");
  glFlush();
  glutSwapBuffers();
